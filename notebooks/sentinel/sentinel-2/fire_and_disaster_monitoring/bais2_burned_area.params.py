...
def get_parameters():
    ...
    parameter_sets = {
        "gran_canaria": {
            "bounding_box": {"west": -15.91, "south": 27.73, "east": -15.29, "north": 28.22},
        ...
        "california_wildfire": {
            "bounding_box": {"west": -120.5, "south": 36.0, "east": -119.5, "north": 37.0},
        ...
        "australia_bushfire": {
            "bounding_box": {"west": 149.0, "south": -37.0, "east": 150.0, "north": -36.0},
